...
export default class CategoryController {
    ...
    public static async getAll(): Promise<ICategory[]> {
        return await Category.findMany<ICategory>();
    }

    public static async getOne(filter: Partial<ICategory>): Promise<ICategory | null> {
        return await Category.findOne<ICategory>(filter);
    }
}
