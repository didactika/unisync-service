...
export default class CourseCampusController {
    ...
    public static async update(
        ...
        courseCampusOnDB.categoryId = data.categoryId || courseCampusOnDB.categoryId;
        courseCampusOnDB.idOnCampus = data.idOnCampus || courseCampusOnDB.idOnCampus;
    ...
    public static async getOneByFilter(filter: CourseCampusFilter): Promise<ICourseCampus | null> {
        return await CourseCampus.findOne(filter);
    }
}
