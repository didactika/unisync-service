...
export default class CourseController {
    ...
    public static async update(courseFound: ICourse, newCourse: Partial<ICourse>): Promise<ICourse> {
        const courseOnDb = new Course(courseFound);
        courseOnDb.fullname = newCourse.fullname || courseOnDb.fullname;
        courseOnDb.shortname = newCourse.shortname || courseOnDb.shortname;
        courseOnDb.idnumber = newCourse.idnumber || courseOnDb.idnumber;
        return await courseOnDb.update();
    }
